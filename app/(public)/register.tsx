...
const Register = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      {!pendingVerification && (
        <>
          <TextInput autoCapitalize="none" placeholder="Bob" value={firstName} onChangeText={setFirstName} style={styles.inputField} />
          <TextInput autoCapitalize="none" placeholder="Cruz" value={lastName} onChangeText={setLastName} style={styles.inputField} />
